...
const features = [
  {
    ...
    desc: "Born and raised in the wild — naturalists, trackers, and storytellers who bring Africa's bush to life.",
  },
  {
    icon: "✦",
    title: "Fully Tailored Itineraries",
    desc: "No two safaris are the same. We design yours around your pace, interests, and dream experiences.",
  },
  {
    icon: "🌿",
    title: "Sustainable & Responsible Travel",
    desc: "We partner with eco-certified lodges and community conservation projects — your adventure gives back.",
  },
  {
    icon: "🛡",
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20 items-center">
        ...
        <RevealWrapper className="relative h-[420px] md:h-[520px]">
          ...
          <div
            className="absolute top-1/2 right-0 -translate-y-1/2 translate-x-1/4
                          ...
                          hidden lg:block"
          >
            <p className="font-serif text-[1.8rem] font-semibold leading-none">
              15+
            </p>
            <p className="text-[0.7rem] tracking-[0.08em] mt-1 opacity-90 leading-tight">
              Years of
              <br />
              Excellence
            </p>
        ...
        <RevealWrapper delay={0.15}>
          ...
          <p className="section-sub !text-white/60 mb-8">
            We go beyond booking tours. Every journey is personally designed to
            connect you with Africa's most breathtaking moments.
          </p>
            ...
            {features.map(({ icon, title, desc }) => (
              <div key={title} className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <p className="text-[0.85rem] text-white/55 leading-[1.65]">
                    {desc}
                  </p>
                </div>
              </div>
