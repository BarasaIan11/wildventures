...
export const metadata = {
  ...
  alternates: {
    canonical: "https://zafronixsafari.com/destinations",
  },
  openGraph: {
    title: "Kenya, Tanzania & Zanzibar Safari Destinations",
    description:
      "Explore Zafronix Safaris' East African destinations — Kenya's Masai Mara, Tanzania's Serengeti, Zanzibar beaches & more.",
    url: "https://zafronixsafari.com/destinations",
    images: [
      {
        url: "https://zafronixsafari.com/images/hero/destinations-hero.png",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ["https://zafronixsafari.com/images/hero/destinations-hero.png"],
  },
};
  ...
  const schema = {
    ...
    itemListElement: destinations.map((dest, index) => ({
      ...
      item: {
        ...
        image: `https://zafronixsafari.com${dest.image}`,
