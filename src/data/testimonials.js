...
//   { id:1, name:'Sarah Mitchell', location:'London, UK', trip:'Great Migration Safari, Kenya', rating:5, featured:false, avatar:'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&q=80', text:"Witnessing the Great Migration was surreal. Zafronix Safaris positioned us perfectly — we were the only vehicle at the river crossing. Pure magic." },
...
export const testimonials = [
  {
    ...
    initials: "SM",
    color: "#2F4F3E",
    text: "Witnessing the Great Migration was surreal. Zafronix Safaris positioned us perfectly — we were the only vehicle at the river crossing. Pure magic.",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    initials: "MT",
    color: "#1E1E1E",
    text: "Looking into the eyes of a mountain gorilla from just a few feet away... there are no words. Zafronix Safaris made this dream come true.",
  },
  {
    id: 5,
    name: "Aisha Kamara",
  ...
  },
  {
    ...
    initials: "HF",
    color: "#2F4F3E",
    text: "Three generations on one safari. Zafronix Safaris handled everything seamlessly. We're already planning our return trip.",
  },
];
